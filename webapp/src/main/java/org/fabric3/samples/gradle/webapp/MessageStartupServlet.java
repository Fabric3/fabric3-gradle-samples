...
*/
package org.fabric3.samples.gradle.webapp;
...
import org.fabric3.samples.gradle.services.MessageService;
import org.fabric3.samples.gradle.services.MessageServiceImpl;

/**
 *
 */
public class MessageStartupServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        domain.deploy("MessageService", messageService);
    ...
    private URL getHttpsBaseUrl(int httpsPort, String httpsUrlParameter) throws ServletException {
        try {
    ...
    private void init(ServletConfig config, URL systemConfig) throws ServletException {
        super.init(config);
    ...
    private URL getHttpBaseUrl(ServletConfig config, int httpPort) throws ServletException {
